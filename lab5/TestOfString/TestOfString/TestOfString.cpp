...
TEST_CASE("checking the return function for the length of the string")
{
	...
	cout << "return length is correct" << endl << endl;
}
...
TEST_CASE("A constructor that initializes a string with a null-terminated string")
{
	...
	cout << "the class was created with the correct data" << endl << endl;
}
...
TEST_CASE("copy constructor")
{
	...
	cout << "the copy constructor works correctly" << endl << endl;
}
...
TEST_CASE("clear function")
{
	...
	cout << "the data in the class has been cleared successfully" << endl << endl;
}
...
TEST_CASE("relocating constructor")
{
	...
	cout << "the move constructor is created correctly" << endl << endl;
}
...
TEST_CASE("a constructor initializing a string with data from a string of the standard C ++ library")
{
	...
	CHECK(line2 == line);
	cout << "the constructor was created correctly" << endl << endl;
}
...
TEST_CASE("function SubString")
{
	...
	cout << "substring from the string is taken correctly" << endl << endl;
}
...
TEST_CASE("operator [] for read")
{
	...
	CMyString line1("hello world");
	CHECK(line1[0] == 'h');
	cout << "operator [] for read works" << endl << endl;
}
...
TEST_CASE("opertator + with other myself string")
{
	...
	cout << "operator + with myString works" << endl << endl;
}
...
TEST_CASE("operator + CMyString with other string")
{
	...
	cout << "operator + with other string c++ works" << endl << endl;
}
...
TEST_CASE("operator + with array of chars")
{
	...
	cout << "operator + with array of chars works" << endl << endl;
}
